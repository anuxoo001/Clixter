...
const Register = () => {
  return (
    <div className="min-h-screen flex items-center justify-center overflow-hidden bg-slate-100 text-slate-950 dark:bg-slate-950 dark:text-slate-100 px-4 py-10">
      ...
      <div className="relative w-full max-w-6xl overflow-hidden rounded-[2rem] border border-slate-200/70 bg-white/80 shadow-[0_40px_120px_-40px_rgba(15,23,42,0.12)] backdrop-blur-xl dark:border-slate-700/70 dark:bg-slate-950/80 dark:shadow-[0_40px_120px_-40px_rgba(15,23,42,0.9)]">
        ...
        <div className="relative grid min-h-[min(80vh,900px)] grid-cols-1 lg:grid-cols-2">
          <div className="hidden lg:flex flex-col justify-center gap-8 p-12 bg-gradient-to-br from-slate-100 via-slate-50 to-slate-100 text-slate-950 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 dark:text-white">
            <div>
              <p className="text-sm uppercase tracking-[0.35em] text-fuchsia-600 dark:text-fuchsia-300">Join Clixter</p>
            ...
            <div className="grid gap-4 text-sm text-slate-700 dark:text-slate-300">
              <div className="rounded-3xl border border-slate-200/70 bg-slate-50/90 p-5 shadow-[0_20px_50px_-30px_rgba(15,23,42,0.08)] transition hover:border-fuchsia-400/40 dark:border-slate-700/80 dark:bg-slate-900/80 dark:shadow-[0_20px_50px_-30px_rgba(15,23,42,0.5)]">
                <p className="font-semibold text-slate-950 dark:text-slate-100">Launch your profile</p>
              ...
              <div className="rounded-3xl border border-slate-200/70 bg-slate-50/90 p-5 shadow-[0_20px_50px_-30px_rgba(15,23,42,0.08)] transition hover:border-cyan-400/40 dark:border-slate-700/80 dark:bg-slate-900/80 dark:shadow-[0_20px_50px_-30px_rgba(15,23,42,0.5)]">
                <p className="font-semibold text-slate-950 dark:text-slate-100">Trusted auth flow</p>
                <p className="mt-2">Secure registration backed by modern cookie-based login.</p>
              </div>
              <div className="rounded-3xl border border-slate-200/70 bg-slate-50/90 p-5 shadow-[0_20px_50px_-30px_rgba(15,23,42,0.08)] transition hover:border-violet-400/40 dark:border-slate-700/80 dark:bg-slate-900/80 dark:shadow-[0_20px_50px_-30px_rgba(15,23,42,0.5)]">
                <p className="font-semibold text-slate-950 dark:text-slate-100">Stylish experience</p>
